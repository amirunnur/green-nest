...
const PlantCare = () => {
  ...
  <h2 className="text-4xl font-bold text-center text-green-800 mb-8">Plant Care Tips</h2>
  <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-6 px-6">
    
    <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
      <h3 className="text-2xl font-bold text-green-700 mb-3"> Watering</h3>
    ...
    <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
      <h3 className="text-2xl font-bold text-yellow-600 mb-3"> Sunlight</h3>
      <ul className="text-gray-700 space-y-1">
    ...
    <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
      <h3 className="text-2xl font-bold text-green-600 mb-3"> Fertilizing</h3>
      <ul className="text-gray-700 space-y-1">
